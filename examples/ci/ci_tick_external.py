...
with nidaqmx.Task(new_task_name="PCI-PY") as task_ci:
    ...
    #For conect a external signal
    task_ci.ci_channels.all.ci_count_edges_term="/Dev1/PFI0"
    
    samps=100000
    #Uncomment If want to use a external base time from de counter, conected to PFI0
