...
Analog adquisition using external analog start trigger
...
with nidaqmx.Task(new_task_name="PCI-PY") as task:
    ...
    #start trigger setup
    task.triggers.start_trigger.cfg_anlg_window_start_trig(
                                                    window_top=5.0,
                                                    window_bottom=2.5,
                                                    trigger_source="Dev1/ai1",
                                                    trigger_when=nidaqmx.constants.WindowTriggerCondition1.ENTERING_WINDOW
                                                    )
...
Some mearuments:  [0.48828125 0.48583984 0.47851562]
